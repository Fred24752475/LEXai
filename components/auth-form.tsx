  ...
  return (
    <div className="rounded-3xl bg-white p-6 shadow-soft ring-1 ring-slate-200">
      <button
        ...
        className="mb-6 flex w-full items-center justify-center gap-3 rounded-2xl border border-slate-200 px-5 py-3 text-sm font-semibold transition hover:bg-slate-50 disabled:opacity-60"
      >
